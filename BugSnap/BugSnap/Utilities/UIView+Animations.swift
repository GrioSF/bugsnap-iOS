...
extension UIView {
    ...
    */
    ...
    /**
        ...
        - Parameter completion: The handler when the animation completes (or is finished earlier)
    */
    func fade( to color: UIColor, duration : TimeInterval = 0.3 , completion : ((Bool)->Void)? = nil) {
