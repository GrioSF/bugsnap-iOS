...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Hector Garcia Pena" => "hgarcia@grio.com" }
  spec.social_media_url   = "https://twitter.com/hrgpac"
  ...
  spec.source       = { :git => "https://github.com/GrioSF/bugsnap-iOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "BugSnap/**/*.swift"
  spec.exclude_files = "BugSnap/BugSnapTests/**"
